public class Main {
    public static void main(String[] args) {
        ...
        var newGame = new GameInfo("EldunRung", "Резня, Маг, Призыватель, Честолюб, Задрот, Кувырок", "Легендарное продолжение серии, с еще большим числом боссов и уроней сложности!", "Игна основанна на костылях, страданиях, боли и 1000 заглушек");
